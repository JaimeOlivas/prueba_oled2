...
extern void ssd1306_init(SSD1306_t * dev, int width, int height);
...
extern void ssd1306_display_text_x3(SSD1306_t * dev, int page, char * text, int text_len, bool invert);
extern void ssd1306_clear_screen(SSD1306_t * dev, bool invert);
void ssd1306_clear_line(SSD1306_t * dev, int page, bool invert);
extern void ssd1306_contrast(SSD1306_t * dev, int contrast);
...
extern void  i2c_master_init(SSD1306_t * dev, int16_t sda, int16_t scl, int16_t reset);
extern void i2c_init(SSD1306_t * dev, int width, int height);
extern void i2c_display_image(SSD1306_t * dev, int page, int seg, uint8_t * images, int width);
extern void i2c_contrast(SSD1306_t * dev, int contrast);
extern void i2c_hardware_scroll(SSD1306_t * dev, ssd1306_scroll_type_t scroll);

extern void spi_master_init(SSD1306_t * dev, int16_t GPIO_MOSI, int16_t GPIO_SCLK, int16_t GPIO_CS, int16_t GPIO_DC, int16_t GPIO_RESET);
extern bool spi_master_write_byte(spi_device_handle_t SPIHandle, const uint8_t* Data, size_t DataLength );
extern bool spi_master_write_command(SSD1306_t * dev, uint8_t Command );
extern bool spi_master_write_data(SSD1306_t * dev, const uint8_t* Data, size_t DataLength );
extern void spi_init(SSD1306_t * dev, int width, int height);
extern void spi_display_image(SSD1306_t * dev, int page, int seg, uint8_t * images, int width);
extern void spi_contrast(SSD1306_t * dev, int contrast);
extern void spi_hardware_scroll(SSD1306_t * dev, ssd1306_scroll_type_t scroll);
